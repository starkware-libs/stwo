...
impl Column<BaseField> for interface::base_field_vec::BaseFieldVec {
    ...
    unsafe fn uninitialized(len: usize) -> Self {
        Self { device_ptr: bindings::cuda_malloc_uint32_t(len), size: len }
    }
...
impl Column<SecureField> for SecureFieldVec {
    ...
    unsafe fn uninitialized(len: usize) -> Self {
        Self { device_ptr: bindings::cuda_malloc_uint32_t(4 * len), size: len }
    }
...
impl Column<Blake2sHash> for Blake2sHashVec {
    ...
    unsafe fn uninitialized(len: usize) -> Self {
        Self { device_ptr: bindings::cuda_malloc_blake_2s_hash(len), size: len }
    }
