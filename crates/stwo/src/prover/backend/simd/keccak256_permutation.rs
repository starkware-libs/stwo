...
//!
//! Intended consumer: a future SIMD implementation of the lifted Keccak Merkle
//! `build_leaves`. Not yet wired up.
...
pub fn keccak_f1600x8(state: &mut [u64x8; PLEN]) {
    for &rc in &RC[..KECCAK_ROUNDS] {
        // Theta.
        let mut c = [u64x8::splat(0); 5];
        for x in 0..5 {
