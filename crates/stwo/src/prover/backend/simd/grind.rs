...
use crate::core::channel::Blake2sChannelImpl;
use crate::core::proof_of_work::GrindOps;
use crate::core::vcs::blake2_hash::Blake2sHasherImpl;
...
impl<const IS_M31_OUTPUT: bool> GrindOps<Blake2sChannelImpl<IS_M31_OUTPUT>> for SimdBackend {
    fn grind(channel: &Blake2sChannelImpl<IS_M31_OUTPUT>, pow_bits: u32) -> u64 {
        ...
        hasher.update(&Blake2sChannelImpl::<IS_M31_OUTPUT>::POW_PREFIX.to_le_bytes());
