...
pub struct PcsConfig {
    ...
    /// extends the polynomials to their LDE domain, then commits to their lift on the domain of
    /// the split composition polynomial (i.e. the last commitment of the pcs). If not `None`, all
