...
impl LiftingLogSize {
    ...
    const fn channel_tag_and_value(&self) -> (u32, u32) {
        match self {
            ...
            LiftingLogSize::Auto => (1, 0),
            LiftingLogSize::AtLeast(log_size) => (2, *log_size),
        }
    }
}
...
mod tests {
    ...
    fn test_lifting_log_size_channel_tag_and_value() {
        ...
        assert_eq!(LiftingLogSize::Auto.channel_tag_and_value(), (1, 0));
        assert_eq!(LiftingLogSize::AtLeast(8).channel_tag_and_value(), (2, 8));
    }
