...
use crate::core::channel::{Blake2sChannelImpl, MerkleChannel};
...
pub type Blake2sMerkleHasher = Blake2sMerkleHasherImpl<false>;
/// Same as [Blake2sMerkleHasher], expect that the hash output is taken modulo M31::P.
pub type Blake2sM31MerkleHasher = Blake2sMerkleHasherImpl<true>;

#[derive(Copy, Clone, Debug, PartialEq, Eq, Default, Deserialize, Serialize)]
pub struct Blake2sMerkleHasherImpl<const IS_M31_OUTPUT: bool>;
impl<const IS_M31_OUTPUT: bool> MerkleHasher for Blake2sMerkleHasherImpl<IS_M31_OUTPUT> {
...
pub type Blake2sMerkleChannel = Blake2sMerkleChannelImpl<false>;
/// Same as [Blake2sMerkleChannel], expect that the hash output is taken modulo M31::P.
pub type Blake2sM31MerkleChannel = Blake2sMerkleChannelImpl<true>;

#[derive(Default)]
pub struct Blake2sMerkleChannelImpl<const IS_M31_OUTPUT: bool>;

impl<const IS_M31_OUTPUT: bool> MerkleChannel for Blake2sMerkleChannelImpl<IS_M31_OUTPUT> {
    type C = Blake2sChannelImpl<IS_M31_OUTPUT>;
    type H = Blake2sMerkleHasherImpl<IS_M31_OUTPUT>;

    fn mix_root(channel: &mut Self::C, root: <Self::H as MerkleHasher>::Hash) {
        channel.update_digest(
            super::blake2_hash::Blake2sHasherImpl::<IS_M31_OUTPUT>::concat_and_hash(
                &channel.digest(),
                &root,
            ),
        );
