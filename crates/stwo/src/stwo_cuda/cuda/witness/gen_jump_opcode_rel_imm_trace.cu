...
__global__ void generate_jump_opcode_rel_imm_trace_kernel(
    ...
    if (row < trace_size) {
        ...
        // if (row == 0) {
        //     printf("CUDA row=%u: input_pc=%u, input_ap=%u, input_fp=%u\n",
        //            row, (unsigned)input_pc_col0, (unsigned)input_ap_col1, (unsigned)input_fp_col2);
        // }
        ...
        // DEBUG: Print instruction Felt252 decomposition
        // if (row == 0) {
        //     printf("CUDA row=%u: instr_id=%u, memory_id_to_big[0..6]=[%u,%u,%u,%u,%u,%u,%u]\n",
        //            row, (unsigned)memory_address_to_id_value_tmp_0,
        //            (unsigned)memory_id_to_big_value_tmp_1[0], (unsigned)memory_id_to_big_value_tmp_1[1],
        //            (unsigned)memory_id_to_big_value_tmp_1[2], (unsigned)memory_id_to_big_value_tmp_1[3],
        //            (unsigned)memory_id_to_big_value_tmp_1[4], (unsigned)memory_id_to_big_value_tmp_1[5],
        //            (unsigned)memory_id_to_big_value_tmp_1[6]);
        // }
        ...
        // DEBUG: Print ap_update_add_1
        // if (row == 0) {
        //     printf("CUDA row=%u: ap_update_add_1_col3=%u\n", row, (unsigned)ap_update_add_1_col3);
        // }
        ...
        // DEBUG: Print PC+1 and next_pc_id
        // if (row == 0) {
        //     printf("CUDA row=%u: pc_plus_1=%u, next_pc_id_col4=%u\n",
        //            row, (unsigned)pc_plus_1, (unsigned)next_pc_id_col4);
        // }
        ...
        // DEBUG: Print next_pc_value (Felt252 limbs)
        // if (row == 0) {
        //     printf("CUDA row=%u: next_pc_value[0..4]=[%u,%u,%u,%u]\n",
        //            row,
        //            (unsigned)next_pc_value[0], (unsigned)next_pc_value[1],
        //            (unsigned)next_pc_value[2], (unsigned)next_pc_value[3]);
        //     printf("CUDA row=%u: next_pc_value[20]=%u, next_pc_value[27]=%u\n",
        //            row, (unsigned)next_pc_value[20], (unsigned)next_pc_value[27]);
        // }
        ...
        // DEBUG: Print msb and mid_limbs_set flags
        // if (row == 0) {
        //     printf("CUDA row=%u: msb_col5=%u, mid_limbs_set_col6=%u\n",
        //            row, (unsigned)msb_col5, (unsigned)mid_limbs_set_col6);
        // }
        ...
        // DEBUG: Print limbs and remainder_bits
        // if (row == 0) {
        //     printf("CUDA row=%u: limb0=%u, limb1=%u, limb2=%u, limb3=%u, remainder_bits=%u\n",
        //            row, (unsigned)next_pc_limb_0_col7, (unsigned)next_pc_limb_1_col8,
        //            (unsigned)next_pc_limb_2_col9, (unsigned)next_pc_value[3], (unsigned)remainder_bits_col10);
        // }
        ...
        lookup_memory_id_to_big_0[22][row] = sub(mul(M31_136, msb_col5), mid_limbs_set_col6);
        ...
        // DEBUG: Print read_small_output and opcodes_1
        // if (row == 0) {
        //     printf("CUDA row=%u: read_small_output(next_pc)=%u\n", row, (unsigned)next_pc);
        //     printf("CUDA row=%u: opcodes_1[0]=%u, opcodes_1[1]=%u, opcodes_1[2]=%u\n",
        //            row,
        //            (unsigned)add(input_pc_col0, next_pc),
        //            (unsigned)add(input_ap_col1, ap_update_add_1_col3),
        //            (unsigned)input_fp_col2);
        // }
