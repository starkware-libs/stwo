/*
============================================
PedersenAggregatorWindowBits9 CUDA Evaluator Header
============================================

Component: PedersenAggregatorWindowBits9 (234 trace columns, 1 preprocessed column)
Adapted from: evaluate_pedersen_aggregator.cuh (window_bits_18 variant)

Trace columns: 234
Preprocessed columns: 1 (seq)

This component performs the Pedersen aggregation with window bits 9:
...
3. 4x PartialEcMulWindowBits9 lookups (2 input, 2 output for 2 chains)
4. 1x MemoryIdToBig lookup for output
5. 1x PedersenAggregatorWindowBits9 PROVIDE relation

Relation uses per row:
  MemoryIdToBig: 3, PartialEcMulWindowBits9: 2, RangeCheck_8: 4
...
#ifndef EVALUATE_PEDERSEN_AGGREGATOR_WINDOW_BITS_9_CUH
#define EVALUATE_PEDERSEN_AGGREGATOR_WINDOW_BITS_9_CUH

#include "fields.cuh"
#include "logup.cuh"
#include "relations.cuh"

// PedersenAggregatorWindowBits9 Evaluation Structure
// Must match the Rust Eval structure layout: eval_id, claim (log_size), common_lookup_elements
struct PedersenAggregator_WB9_Eval {
    unsigned eval_id;
    struct {
        unsigned log_size;
    } claim;
...
extern "C" void evaluate_pedersen_aggregator_window_bits_9(
...
#endif // EVALUATE_PEDERSEN_AGGREGATOR_WINDOW_BITS_9_CUH
