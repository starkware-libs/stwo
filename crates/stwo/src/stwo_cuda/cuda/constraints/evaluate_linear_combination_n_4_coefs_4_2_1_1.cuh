/*
============================================
LinearCombinationN4Coefs4211 CUDA Subroutine
============================================

Subroutine: LinearCombinationN4Coefs4211
translated from: cairo-air/src/comptogethernts/subroutines/linear_combination_n_4_coefs_4_2_1_1.rs
AIR version: 54d95c0d

Functionality:
- Computes linear combination of 4 inputs with coefficients [4, 2, 1, 1]
- Input: 40 limbs (4 groups of 10 limbs each)
- Output: Verified sum in 10 combination limbs + p_coef
- Formula: 4*input_0 + 2*input_1 + input_2 + input_3 = combination + p_coef * p (mod p)
...
#ifndef EVALUATE_LINEAR_COMBINATION_N_4_COEFS_4_2_1_1_H
#define EVALUATE_LINEAR_COMBINATION_N_4_COEFS_4_2_1_1_H
...
DEVICE_FORCEINLINE void linear_combination_n_4_coefs_4_2_1_1_evaluate(
    m31 input_limb_0,
    m31 input_limb_1,
    m31 input_limb_2,
    m31 input_limb_3,
    ...
    // ===================== Carry Computations =====================
    // carry_0 = ((4*input_0 + 2*input_10 + input_20 + input_30 - combination_0 - p_coef) * 16)
    m31 carry_0 = mul(
        sub(
            sub(
                add(
    ...
    // carry_1 = ((carry_0 + 4*input_1 + 2*input_11 + input_21 + input_31 - combination_1) * 16)
    m31 carry_1 = mul(
        sub(
            add(
                add(
    ...
    // carry_2 = ((carry_1 + 4*input_2 + 2*input_12 + input_22 + input_32 - combination_2) * 16)
    m31 carry_2 = mul(
        sub(
            add(
                add(
    ...
    // carry_3 = ((carry_2 + 4*input_3 + 2*input_13 + input_23 + input_33 - combination_3) * 16)
    m31 carry_3 = mul(
        sub(
            add(
                add(
    ...
    // carry_4 = ((carry_3 + 4*input_4 + 2*input_14 + input_24 + input_34 - combination_4) * 16)
    m31 carry_4 = mul(
        sub(
            add(
                add(
    ...
    // carry_5 = ((carry_4 + 4*input_5 + 2*input_15 + input_25 + input_35 - combination_5) * 16)
    m31 carry_5 = mul(
        sub(
            add(
                add(
    ...
    // carry_6 = ((carry_5 + 4*input_6 + 2*input_16 + input_26 + input_36 - combination_6) * 16)
    m31 carry_6 = mul(
        sub(
            add(
                add(
    ...
    // carry_7 = ((carry_6 + 4*input_7 + 2*input_17 + input_27 + input_37 - combination_7 - p_coef*136) * 16)
    m31 carry_7 = mul(
        sub(
            sub(
                add(
    ...
    // carry_8 = ((carry_7 + 4*input_8 + 2*input_18 + input_28 + input_38 - combination_8) * 16)
    m31 carry_8 = mul(
        sub(
            add(
                add(
    ...
    // carry_8 + 4*input_9 + 2*input_19 + input_29 + input_39 - combination_9 - p_coef*256 = 0
    ...
    // Each carry must satisfy: carry ∈ {-1, 0, 1}
    // For coefficients [4, 2, 1, 1], range is [-1, 1]
    ...
    //   - First RangeCheck_4_4_4_4: p_coef, carry_0, carry_1, carry_2 (each + 1 for biasing)
    //   - Second RangeCheck_4_4_4_4: carry_3, carry_4, carry_5, carry_6 (each + 1 for biasing)
...
#endif // EVALUATE_LINEAR_COMBINATION_N_4_COEFS_4_2_1_1_H
