...
fn test_butterfly_component() {
    ...
    let butterfly_component = ButterflyGate {
        inputs: (0..16)
            .map(|i| {
                (
    ...
    registry.register_component("MulGate".to_string(), MulGate::default());
    registry.register_component("AddGate".to_string(), AddGate::default());
