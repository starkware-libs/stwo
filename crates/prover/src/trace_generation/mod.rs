...
pub struct ComponentRegistry {
    _components: HashMap<u32, Box<dyn ComponentGen>>,
}
...
trait TraceGenerator<B: Backend> {
    ...
    /// this component.
    fn add_inputs(&mut self, inputs: &[Self::ComponentInput]);
    ...
    // TODO(ShaharS): change id to a struct that contains the id and the component name.
    fn write_trace(
        id: u32,
