...
pub fn fri_answers_for_log_size(
    ...
    // TODO(andrew): This code is very similar to FriLayerVerifier::extract_evaluation. Consider
    // breaking out the shared functionality. The different domains make it a little fiddly.
