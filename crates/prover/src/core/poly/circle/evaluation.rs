...
impl<B: PolyOps + ColumnOps<SecureField>> CircleEvaluation<B, BaseField, BitReversedOrder> {
    ...
    pub fn barycentric_weights(
        ...
        B::barycentric_weights(log_size, sample_point)
    }
        ...
        let sampled_barycentric_values = sampled_points
            ...
            .map(|point| {
                eval.barycentric_eval_at_point(
                    *point,
                    &super::CircleEvaluation::<CpuBackend, BaseField, BitReversedOrder>::barycentric_weights(
    ...
    fn test_simd_barycentric_evaluation() {
        ...
        let sampled_barycentric_values = sampled_points
            ...
            .map(|point| {
                eval.barycentric_eval_at_point(
                    *point,
                    &super::CircleEvaluation::<SimdBackend, BaseField, BitReversedOrder>::barycentric_weights(
                        eval.domain.log_size(),
                        *point,
                    ),
                )
