...
impl MerkleHasher for Poseidon252MerkleHasher {
    ...
    fn hash_node(
        ...
        let n_column_blocks = column_values.len().div_ceil(ELS_IN_BLOCK);
        ...
        let padding_length = ELS_IN_BLOCK * n_column_blocks - column_values.len();
