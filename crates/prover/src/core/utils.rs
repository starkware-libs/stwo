...
mod tests {
    ...
    fn test_offset_bit_reversed_circle_domain_index() {
        let actual = offset_bit_reversed_circle_domain_index(5, 3, 6, -2);
        let expected = previous_bit_reversed_circle_domain_index(
            previous_bit_reversed_circle_domain_index(5, 3, 6),
            3,
            6,
        );
