...
pub struct QuotientConstants {
    ...
    pub denominator_inverses: Vec<CMFieldVec>,
}
...
fn denominator_inverses(
    ...
    let flat_denominators: CMFieldVec = sample_batches
        .iter()
    ...
    let mut flat_denominator_inverses = unsafe { CMFieldVec::uninit(flat_denominators.len()) };
