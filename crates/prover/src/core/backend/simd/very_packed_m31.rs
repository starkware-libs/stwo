...
unsafe impl Pod for VeryPackedM31 {}
unsafe impl Zeroable for VeryPackedM31 {
    fn zeroed() -> Self {
        unsafe { core::mem::zeroed() }
    }
}

unsafe impl Pod for VeryPackedCM31 {}
unsafe impl Zeroable for VeryPackedCM31 {
    fn zeroed() -> Self {
        unsafe { core::mem::zeroed() }
    }
}

unsafe impl Pod for VeryPackedQM31 {}
unsafe impl Zeroable for VeryPackedQM31 {
    fn zeroed() -> Self {
        unsafe { core::mem::zeroed() }
    }
}
