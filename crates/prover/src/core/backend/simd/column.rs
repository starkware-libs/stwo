...
impl Column<BaseField> for BaseFieldVec {
    ...
    unsafe fn uninit(length: usize) -> Self {
...
#[derive(Clone, Debug)]
pub struct CMFieldVec {
    pub data: Vec<PackedCM31>,
    pub length: usize,
}

impl Column<CM31> for CMFieldVec {
    fn zeros(length: usize) -> Self {
        Self {
...
impl FromIterator<CM31> for CMFieldVec {
...
impl FromIterator<PackedCM31> for CMFieldVec {
