...
//!
//! // Create a new span accumulator.
//! let collector = SpanAccumulator::default();
//!
//! // Register it with the tracing subscriber.
//! let subscriber = Registry::default().with(collector.clone());
//! let _guard = tracing::subscriber::set_default(subscriber);
//!
//! // Create and enter spans to measure their duration.
//! let span = tracing::span!(tracing::Level::INFO, "operation_name").entered();
//! // ... perform work ...
//! span.exit(); // When the span is dropped, its duration is accumulated
//!
//! // Export the results
