...
use crate::constraint_framework::{EvalAtRow, INTERACTION_TRACE_IDX, Relation, RelationEntry};
...
let constraint_1 = (QM31Impl::from_partial_evals([trace_2_column_3_offset_0, \
             ...
             trace_2_column_6_offset_neg_1]) - ((total_sum) * (preprocessed_is_first)))) * \
    ...
    impl FrameworkEval for TestStruct {
        ...
        fn evaluate<E: EvalAtRow>(&self, mut eval: E) -> E {
            ...
            eval.add_to_relation(RelationEntry::new(&TestRelation::dummy(), E::EF::one(), &[
                x0, x1, x2,
            ]));
            eval.finalize_logup();
            eval
