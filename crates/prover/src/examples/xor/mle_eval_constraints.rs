...
mod tests {
    ...
    fn gen_base_trace(
        ...
        let mle_coeff_columns = mle_coeffs.into_secure_column().columns;
        let eq_evals_columns = eq_evals.into_secure_column().columns;
        let mle_terms_columns = mle_terms.into_secure_column().columns;
