...
use super::blake_scheduler_info;
...
use crate::examples::blake::round::BlakeRoundInput;
use crate::examples::blake::{to_felts, N_ROUNDS};
...
pub struct BlakeSchedulerLookupData {
    pub round_lookups: [[BaseColumn; 16 * 3 * 2]; N_ROUNDS],
    pub blake_lookups: [BaseColumn; 16 * 3 * 2],
}
