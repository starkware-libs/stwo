...
impl Component for BlakeRoundComponent {
    fn n_constraints(&self) -> usize {
        ...
        counter.eval();
        assert_eq!(counter.n_cols, N_COLUMNS);
    ...
    fn trace_log_degree_bounds(&self) -> TreeVec<ColumnVec<u32>> {
        let mut counter = BlakeConstraintCounter::default();
        counter.eval();
        TreeVec::new(vec![vec![self.log_size; counter.n_cols], vec![]])
    }
...
impl ComponentProver<SimdBackend> for BlakeRoundComponent {
    fn evaluate_constraint_quotients_on_domain(
        ...
        for vec_row in 0..(1 << (eval_domain.log_size() - LOG_N_LANES)) {
            ...
            evaluator.eval();
            assert_eq!(evaluator.col_index, N_COLUMNS);
...
impl BlakeTraceGenerator {
    ...
    fn gen_row(&mut self, v: [u32x16; 16], m: [u32x16; 16]) {
        ...
        assert_eq!(self.col_index, N_COLUMNS);
    }
...
mod tests {
    ...
    use crate::examples::blake::{BlakeAir, BlakeRoundComponent, BlakeTraceGenerator};
