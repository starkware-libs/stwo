...
mod tests {
    ...
    fn test_wide_fibonacci_constraints_fails() {
        ...
        let mut trace = generate_trace::<FIB_SEQUENCE_LENGTH>(LOG_N_ROWS, &inputs);
    ...
    fn test_wide_fib_prove() {
        ...
        let inputs = (0..(1 << (LOG_N_INSTANCES - LOG_N_LANES)))
            ...
            .collect_vec();
        let trace = generate_trace::<FIB_SEQUENCE_LENGTH>(component.log_size(), &inputs);
