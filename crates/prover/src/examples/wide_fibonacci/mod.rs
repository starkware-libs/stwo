...
mod tests {
    ...
    use super::component::{
        fill_initial_trace, lookup_columns, Input, WideFibAir, WideFibComponent, LOG_N_COLUMNS,
        LOG_N_ROWS,
    };
    ...
    fn test_trace_row_constraints() {
        ...
        let trace = fill_initial_trace(&wide_fib, vec![input, input]);
    ...
    fn test_lookup_column_constraints() {
        ...
        let alpha = m31!(1);
        let z = m31!(2);
        let trace = fill_initial_trace(&wide_fib, vec![input]);
    ...
    fn test_composition_is_low_degree() {
        ...
        let trace = fill_initial_trace(&wide_fib, inputs);
    ...
    fn test_prove() {
        ...
        let private_input = (0..(1 << LOG_N_INSTANCES))
            ...
            .collect();
        let trace = fill_initial_trace(&component, private_input);
