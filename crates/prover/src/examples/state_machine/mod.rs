...
pub fn prove_state_machine(
    ...
    let component0 = StateMachineOp0Component::new(
        ...
        total_sum_op0,
        Some((claimed_sum_op0, x_row as usize - 1)),
    );
    let component1 = StateMachineOp1Component::new(
        ...
        total_sum_op1,
        Some((claimed_sum_op1, y_row as usize - 1)),
    );
...
mod tests {
    ...
    use crate::constraint_framework::{
        assert_constraints, FrameworkEval, RelationType, TraceLocationAllocator,
    };
    use crate::core::channel::Blake2sChannel;
    use crate::core::fields::m31::M31;
    use crate::core::fields::qm31::QM31;
