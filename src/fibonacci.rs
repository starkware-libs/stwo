...
use crate::core::commitment_scheme::CommitmentScheme;
...
impl Fibonacci {
    ...
    pub fn prove(&self) -> FibonacciProof {
        ...
        let trace_commitment_scheme = CommitmentScheme::new(
            vec![trace_poly],
        ...
        let composition_polynomial_commitment_scheme = CommitmentScheme::new(
