...
impl Fibonacci {
    ...
    pub fn prove(self) -> FibonacciProof {
        ...
        let oods_value = quotient_poly.eval_at_point(oods_point);
        let conjugate_oods_value = quotient_poly.eval_at_point(-oods_point);
        oods_quotients.push(get_oods_quotient(
            oods_point,
            oods_value,
        ...
        oods_quotients.push(get_oods_quotient(
            -oods_point,
            conjugate_oods_value,
            &quotient_commitment_evaluation,
        ));
        let quotient_oods_evaluation = PointMapping::new(
            [
                (oods_point, oods_value),
                (-oods_point, conjugate_oods_value),
            ]
            .into(),
        );
