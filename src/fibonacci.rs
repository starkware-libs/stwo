...
pub type Channel = Blake2sChannel;
...
pub struct FibonacciProof {
    ...
    pub trace_commitment: <<Channel as ChannelTrait>::ChannelHasher as Hasher>::Hash,
    pub quotient_commitment: <<Channel as ChannelTrait>::ChannelHasher as Hasher>::Hash,
}
...
impl Fibonacci {
    ...
    pub fn prove(self) -> FibonacciProof {
        ...
        let trace_merkle =
            MerkleTree::<BaseField, <Channel as ChannelTrait>::ChannelHasher>::commit(vec![
                extended_evaluation.values.clone(),
            ]);
        ...
        let quotient_merkle =
            MerkleTree::<QM31, <Channel as ChannelTrait>::ChannelHasher>::commit(vec![
                quotient_values.clone(),
            ]);
