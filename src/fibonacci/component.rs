...
use crate::core::backend::cpu::N_SECUREFIELD_IN_CACHE;
    ...
    FibonacciComponent: Component<CPUBackend>,
{
    fn accumulate_step_constraint(
        ...
        for (off, point_coset) in [
            ...
            if point_coset.size() < N_SECUREFIELD_IN_CACHE {
                    ...
                    .array_chunks::<N_SECUREFIELD_IN_CACHE>()
                {
                    ...
                    let mut buff: [BaseField; N_SECUREFIELD_IN_CACHE] = std::array::from_fn(|i| {
                        let point = chunk[i].1;
                        self.step_constraint_denominator(point)
                    });
                    let mut inverses_buff = [BaseField::zero(); N_SECUREFIELD_IN_CACHE];
        ...
        for (off, point_coset) in [
            ...
            if point_coset.size() < N_SECUREFIELD_IN_CACHE {
                    ...
                    .array_chunks::<N_SECUREFIELD_IN_CACHE>()
                {
                    ...
                    let mut inversed_buff = [BaseField::zero(); N_SECUREFIELD_IN_CACHE];
