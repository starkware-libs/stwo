...
mod tests {
    ...
    use crate::core::utils::{bit_reverse, project_secure_eval};
    ...
    fn test_oods_quotients_are_low_degree() {
        ...
        for quotient in trace_quotients.iter() {
            let interpolated_quotient_poly = project_secure_eval(quotient).interpolate();
        ...
        let interpolated_quotient_poly =
            project_secure_eval(composition_polynomial_quotient).interpolate();
