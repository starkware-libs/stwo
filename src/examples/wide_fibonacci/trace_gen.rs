...
pub fn write_lookup_column(
    ...
    let row_4_a = input_trace[column_offset][4];
    let row_4_b = input_trace[column_offset + 1][4];
    dst[4] = (row_4_a + alpha * row_4_b - z) * dst[3];
    let row_5_a = input_trace[column_offset][5];
    let row_5_b = input_trace[column_offset + 1][5];
    dst[5] = (row_5_a + alpha * row_5_b - z) * dst[4];
    let row_6_a = input_trace[column_offset][6];
    let row_6_b = input_trace[column_offset + 1][6];
    dst[6] = (row_6_a + alpha * row_6_b - z) * dst[5];
    let row_7_a = input_trace[column_offset][7];
    let row_7_b = input_trace[column_offset + 1][7];
    dst[7] = (row_7_a + alpha * row_7_b - z) * dst[6];
}
