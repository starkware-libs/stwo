...
use super::utils::queried_nodes_in_layer;
...
impl<F: Field, H: Hasher> MixedDecommitment<F, H> {
    ...
    fn verify_single_layer<'a>(
        ...
        witness_elements: &mut impl Iterator<Item = F>,
        witness_hashes_iter: &mut impl Iterator<Item = &'a H::Hash>,
...
mod tests {
    ...
    fn verify_test() {
        ...
        let decommitment = tree.decommit(queries.as_slice());
