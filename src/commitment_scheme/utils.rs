...
/// Given a data of a tree, and a bottom layer of 'bottom_layer_node_size_bytes' sized nodes, hashes the entire tree.
/// Nodes are hashed individually at the bottom layer.
...
mod tests {
    ...
    use super::{allocate_balanced_tree, hash_merkle_tree, map_columns_sorted, ColumnArray};
    use crate::{
        commitment_scheme::{
            blake3_hash::Blake3Hasher,
            hasher::Hasher,
            utils::{
                allocate_layer, hash_layer, hash_merkle_tree_from_bottom_layer, inject,
