...
pub fn hash_layer<H: BasicHasher>(
    layer: &[H::NativeType],
    node_size: usize,
...
pub fn hash_merkle_tree<H: BasicHasher>(data: &mut [&mut [H::NativeType]]) {
...
pub fn hash_merkle_tree_from_bottom_layer<'a, F: Field, H: BasicHasher>(
    bottom_layer: &[F],
...
pub fn inject_hash_in_pairs<'a: 'b, 'b, H: BasicHasher>(
...
///  
pub fn inject_column_chunks<'b, 'a: 'b, H: BasicHasher, F: Field>(
    columns: &'a [&'a [F]],
    hash_inputs: &'b mut [Vec<&'a [H::NativeType]>],
    chunk_idx: usize,
