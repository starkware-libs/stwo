...
mod tests {
    ...
    fn merkle_hash_works() {
        ...
        let root_hex = format!("{}",MerkleTree::<blake3_hash::Blake3Hasher>::root_without_caching(&leaves));
        assert_eq!(
            root_hex,
    ...
    fn merkle_tree_building() {
        ...
        tree.commit();
        assert_eq!(tree.root_hex(), "e1104b50ab4d8c2ea9a47b7d8be80cc03302e523f0510dfcf383086467306897")
