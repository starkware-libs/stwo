    ...
    F: IntoSlice<H::NativeType>,
{
    ...
    ///
    ///
    /// let (tree, commitment) = MixedDegreeMerkleTree::<M31, Blake3Hasher>::commit(&input, config);
    pub fn commit(
...
mod tests {
    ...
    fn commit_configured_multi_layer_sizes_test() {
        ...
        let (tree, _root) = MixedDegreeMerkleTree::<M31, Blake3Hasher>::commit(
            &input,
    ...
    fn mixed_degree_merkle_tree_bad_config_test() {
        ...
        MixedDegreeMerkleTree::<M31, Blake3Hasher>::commit(
            &input,
            MixedDegreeMerkleTreeConfig {
    ...
    fn commit_configured_test() {
        ...
        let (_, root) = MixedDegreeMerkleTree::<M31, Blake3Hasher>::commit(&input, config);
