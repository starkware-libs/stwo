...
mod tests {
    ...
    fn hash_symmetric_path<H: Hasher>(iv: &[H::NativeType], n: usize) -> H::Hash {
        (1..n).fold(H::hash(iv), |curr_hash, _| {
    ...
    fn hash_sub_tree_intermediate_test() {
        ...
        let expected_root0 =
            hash_symmetric_path::<Blake3Hasher>(leaf_0_input.as_slice(), sub_trees_height);
        let expected_root1 =
            hash_symmetric_path::<Blake3Hasher>(leaf_1_input.as_slice(), sub_trees_height);
    ...
    fn commit_layer_non_intermediate_test() {
        ...
        // Column will get spread to one value per leaf.
        let expected_root0 =
            hash_symmetric_path::<Blake3Hasher>(&1_u32.to_le_bytes(), sub_trees_height);
        let expected_root1 =
            hash_symmetric_path::<Blake3Hasher>(&2_u32.to_le_bytes(), sub_trees_height);
