...
impl<H: Hasher> MerkleMultiLayer<H> {
    ...
    //                 bag_position_in_layer: position_in_layer,
    //                 hash: hash_witness,
    //                 injected_elements,
    //             });
    //         }
...
mod tests {
    ...
    //     // Parents of 0,1 should not contain a hash as they can both be calculated by the
    // verifier.     assert_eq!(decommitment.decommitment_layers[0][0].hash, None);
    //     assert_eq!(
    ...
    //     );
    //     assert_eq!(
    //         decommitment.decommitment_layers[0][0].bag_position_in_layer,
    ...
    //     );
    //     assert_eq!(
    //         decommitment.decommitment_layers[0][1].bag_position_in_layer,
    ...
    //     );
    //     assert_eq!(
    //         decommitment.decommitment_layers[0][2].bag_position_in_layer,
    //         PositionInLayer::Left(14)
    //     );

    //     // Layer #2
    //     assert_eq!(
    //         decommitment.decommitment_layers[1][0].bag_position_in_layer,
    //         PositionInLayer::Right(1)
    //     );
    //     assert_eq!(
    //         decommitment.decommitment_layers[1][1].bag_position_in_layer,
    //         PositionInLayer::Left(2)
    //     );
    //     assert_eq!(
    //         decommitment.decommitment_layers[1][2].bag_position_in_layer,
    //         PositionInLayer::Left(6)
    //     );

    //     // Layer #3
    //     assert_eq!(
    //         decommitment.decommitment_layers[2][0].bag_position_in_layer,
    //         PositionInLayer::Left(2)
    //     );
    // }
}
