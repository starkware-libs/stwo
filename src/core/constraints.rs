...
use super::poly::circle::{CircleEvaluation, CirclePoly, PointMapping, PolyOps};
...
#[derive(Copy, Clone)]
pub struct EvalByPoly<'a, B: FieldOps<F> + Backend, F: ExtensionOf<BaseField>> {
...
impl<'a, B: FieldOps<F> + PolyOps<F> + Backend, F: ExtensionOf<BaseField>> PolyOracle<F>
...
mod tests {
    ...
    fn test_point_vanishing_degree() {
        ...
        let quotient_evaluation =
            CircleEvaluation::<CPUBackend, QM31>::new(large_domain, quotient_polynomial_values);
