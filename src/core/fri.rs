...
pub struct FriProver<H: Hasher> {
    ...
    /// Sizes of committed columns sorted in descending order.
...
/// Given the queries of the largest domain and the log sizes of all the columns, returns the
/// opening positions needed for verification.
