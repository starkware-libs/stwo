...
/// given the queries of the original domain and the (log) domain ratio between it and the folded
/// domain.
pub fn get_folded_queries(queries: &BTreeSet<usize>, log_domain_ratio: u32) -> BTreeSet<usize> {
