...
pub fn verify(
    ...
    {
        return Err(VerificationError::OodsVerificationError);
    }
...
pub enum VerificationError {
    #[error("The composition polynomial OODS value does not match the trace OODS values.")]
    OodsVerificationError,
    #[error(transparent)]
    FriVerificationError(#[from] FriVerificationError),
    #[error(transparent)]
    ProofOfWorkVerificationError(#[from] ProofOfWorkVerificationError),
}
