...
impl SecureColumn<AVX512Backend> {
    ...
    pub unsafe fn set_packed(&mut self, pack_index: usize, value: PackedQM31) {
        *self.cols[0].data.get_unchecked_mut(pack_index) = value.a().a();
        *self.cols[1].data.get_unchecked_mut(pack_index) = value.a().b();
        *self.cols[2].data.get_unchecked_mut(pack_index) = value.b().a();
        *self.cols[3].data.get_unchecked_mut(pack_index) = value.b().b();
    }
    ...
    pub unsafe fn get_packed(&self, pack_index: usize) -> PackedQM31 {
        PackedQM31([
            PackedCM31([
                *self.cols[0].data.get_unchecked(pack_index),
                *self.cols[1].data.get_unchecked(pack_index),
            ]),
            PackedCM31([
                *self.cols[2].data.get_unchecked(pack_index),
                *self.cols[3].data.get_unchecked(pack_index),
            ]),
        ])
    }
}
