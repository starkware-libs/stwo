...
fn bit_reverse16(data: [[BaseField; 16]; 16]) -> [[BaseField; 16]; 16] {
    ...
    for _ in 0..4 {
        ...
        // For example, the second call interleaves 0010:0xyz with 0011:0xyz,
        // and stores in word 0001.
        // This results in 0001:xyz0 <= 0010:0xyz and in 0001:xyz1 <= 0011:0xyz,
        // or 001w:0xyz => 0001:xyzw.
        unsafe {
            data = [
