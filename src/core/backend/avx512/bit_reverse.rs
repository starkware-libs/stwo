...
fn bit_reverse16(data: [[BaseField; 16]; 16]) -> [[BaseField; 16]; 16] {
    ...
    for _ in 0..4 {
        ...
        // For example, the first call interleaves 0000:0xyz with 0001:0xyz,
        // and stores in word 0000.
        // This results in 0000:xyz0 <= 0000:0xyz and in 0000:xyz1 <= 0001:0xyz,
        // or 000w:0xyz => 0000:xyzw.
        unsafe {
            data = [
