...
use super::{
    compute_first_twiddles, EVENS_INTERLEAVE_EVENS, HHALF_INTERLEAVE_HHALF, LHALF_INTERLEAVE_LHALF,
...
pub unsafe fn vecwise_butterflies(
    ...
    (val0, val1) = (
        val0.permute_with(LHALF_INTERLEAVE_LHALF, val1),
        val0.permute_with(HHALF_INTERLEAVE_HHALF, val1),
    );
